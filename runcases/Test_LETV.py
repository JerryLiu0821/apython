...
class captureMeminfo(threading.Thread):        
    def __init__(self, id,dir):
        ...
        self.id = id
    def run(self):
        dump_mem = 'dumpsys_meminfo.log'
        procrank = 'prockrank.log'
        while True:
...
def main():
    device_serial_number = __import__(config_file.strip('.py')).DEVICES['TestDevice']['id']
