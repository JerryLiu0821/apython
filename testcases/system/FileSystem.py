...
class TestFileSystem(unittest.TestCase):
    ...
    def testMultipleSubDir(self):
        ...
        try:
            ...
            ua = Stability.UiAutomator(self.id, self.jar, self.case, "mediaPath", "%sxuanmu.mp3" %mediaPath)
            ...
            cmd4 = "am start -a android.intent.action.VIEW -n com.stv.videoplayer/.MainActivity -d file://%sxuanmu.mp3" %mediaPath
            print self.a.device.sh(cmd3)
            print self.a.device.sh(cmd4)
            time.sleep(15)
