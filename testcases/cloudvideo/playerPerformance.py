...
class TestPlayerPerformance(unittest.TestCase):
    ...
    def _testRebootPlayerStartTime(self):
    ...
    def _testTunerToLiveLoadingTime(self):
    ...
    def _testCVBSToLiveLoadingTime(self):
    ...
    def _testVGAToLiveLoadingTime(self):
    ...
    def _testHDMIToLiveLoadingTime(self):
    ...
    def _testVideoPrepareToFirstFrame(self):
        ...
        try:
            self.url = "http://10.154.250.32:8080/vod/a.m3u8"
    ...
    def _testLivePlayPrepareTime(self):
    ...
    def _testLivePlayerCloseTime(self):
    ...
    def testVodPlayPrepareTime(self):
        ...
        try:
            ...
            cmd = "am start -a android.intent.action.VIEW -d \'%s\' -n com.stv.videoplayer/.MainActivity" % self.url
            self.a.device.sh(cmd)
            time.sleep(30)
            log_dir = os.path.join(android.log.report_directory(), android.log.logs_directory(), 'logcat_main.%s.1.txt' % self.id)
            print log_dir
